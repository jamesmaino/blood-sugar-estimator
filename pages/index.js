...
import BloodSugarEstimate from "../components/BloodSugarEstimate";
...
function HomePage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      console.log({ nutritionData: nutrition.data });
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <BloodSugarEstimate nutrition={nutrition} />
      </Container>
    </ThemeProvider>
  );
}
